...
const DaneOrder = ({ id, hide }) => {
    console.log(id);
    
    const handleCancel = async () => {
        try {
          await axios.get(`https://daily-api.onrender.com/order/done/${id}`);
          hide();
        } catch (error) {
        ...
        >
          ...
          >
            ...
            <p className="text-center text-gray-600 mb-6">
              Do you really want to done this Order? This action cannot be undone.
            </p>
